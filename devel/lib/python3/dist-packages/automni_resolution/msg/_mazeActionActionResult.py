...
"""autogenerated by genpy from automni_resolution/mazeActionActionResult.msg. Do not edit."""
import codecs
import sys
...
class mazeActionActionResult(genpy.Message):
  _md5sum = "5489bcfa93e36e07a0b801f3ac4c7c97"
  _type = "automni_resolution/mazeActionActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','automni_resolution/mazeActionResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(mazeActionActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = automni_resolution.msg.mazeActionResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = automni_resolution.msg.mazeActionResult()
